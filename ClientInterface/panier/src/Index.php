        ...
        <div class="col-md-4 col-12 text-center">
            <div class="card mr-2 d-inline-block shadow-lg">
                ...
                <div class="card-body">
                  ...
                  <p class="text-black-50">El Boss</p>
                </div>
              </div>
        </div>
                ...
                <div class="carousel-inner text-center">
                  <div class="carousel-item active">
                    <div class="card mr-2 d-inline-block shadow">
                      ...
                      <div class="card-body">
                        ...
                        <a href="#" class="text-secondary text-decoration-none">Go INSAT</a>
                        <p class="text-black-50">La khedma la guedma</p>
                      </div>
                    </div>
                  </div>
                  <div class="carousel-item">
                    <div class="card  d-inline-block mr-2 shadow">
                      ...
                      <div class="card-body">
                        <h3 class="card-title">Rayenne Knani</h3>
                        <p class="card-text">
                          Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint iure autem recusandae, veniam, illo dolor soluta assumenda
                          minima quia velit officia sit exercitationem nam ipsa, repellendus aut facilis quasi voluptas!
                        </p>
                        <a href="#" class="text-secondary text-decoration-none">Go INSAT</a>
                        <p class="text-black-50">Battal</p>
                      </div>
                    </div>
                  </div>
              </div>
        ...
        <div class="col-md-4 col-12 text-center">
            <div class="card mr-2 d-inline-block shadow-lg">
                ...
                <div class="card-body">
                  ...
                  <a href="#" class="text-secondary text-decoration-none">Go INSAT</a>
                  <p class="text-black-50">Ta9ra ktob</p>
                </div>
              </div>
        </div>
      </div>
